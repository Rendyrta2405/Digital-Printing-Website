...
<head>
  ...
  <title>Kartu Nama - Percetakan Online</title>
  <!-- Bootstrap 5 CSS -->
...
<!-- Floating WhatsApp -->
<a href="https://wa.me/6283171125657?text=Halo%20saya%20ingin%20pesan%20kartu%20nama" class="floating-wa" target="_blank">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="/Kartu-Nama/">Kartu Nama</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6" data-aos="fade-right" data-aos-duration="1000">
        <h1>Kartu Nama Profesional & Berkualitas</h1>
        <p class="mb-4">Cetak kartu nama dengan berbagai pilihan bahan dan finishing. Tampil profesional dan berkesan dengan desain custom sesuai keinginan Anda.</p>
        <div class="d-flex flex-wrap gap-3">
          <a href="https://wa.me/6283171125657?text=Halo%20Toko%20Percetakan%2C%20saya%20ingin%20konsultasi%20cetak%20kartu%20nama." class="btn btn-wa" target="_blank">
      ...
      <div class="col-md-6 text-center mt-4" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
        <img src="/assets/hero-kartu-nama.jpg" alt="Ilustrasi Kartu Nama" class="img-fluid rounded">
      </div>
    </div>
  </div>
</section>
...
<section class="py-5 bg-light" id="harga-section">
  <div class="container">
    <h2 class="section-title" data-aos="fade-down" data-aos-duration="800">Daftar Harga <span>Kartu Nama</span></h2>
    <div class="row g-4">
      <div class="col-md-8 mx-auto">
        <div class="price-section">
          <h4 class="text-center fw-bold mb-3"><i class="bi bi-card-text text-primary me-2"></i>Harga Kartu Nama</h4>
          <div class="price-item">
            <span class="size">Art Paper 260gsm (per box)</span>
            <span class="price">Rp 50.000</span>
          </div>
          <div class="price-item">
            <span class="size">Art Carton 310gsm (per box)</span>
            <span class="price">Rp 65.000</span>
          </div>
          <div class="price-item">
            <span class="size">Doff / Matte (per box)</span>
            <span class="price">Rp 70.000</span>
          </div>
          <div class="price-item">
            <span class="size">Glossy / Laminasi (per box)</span>
            <span class="price">Rp 75.000</span>
          </div>
          <div class="price-item">
            <span class="size">Premium / Emboss (per box)</span>
            <span class="price">Rp 100.000</span>
          </div>
          <div class="price-note">*1 box = 100 lembar. Harga belum termasuk desain.</div>
        </div>
      </div>
    </div>
  </div>
...
<!-- Grid Produk Kartu Nama -->
<section class="container overflow-hidden py-5" id="product">
  <div class="row g-4" id="product-grid">
    <!-- Kartu Nama Art Paper -->
    <div class="col-md-4 col-sm-6 product-item" data-aos="fade-up" data-aos-delay="100">
      <div class="product-card">
        <div class="product-image">
          <img src="/assets/kartu-nama-art-paper.jpg" alt="Kartu Nama Art Paper" onclick="openLightbox(this.src)">
          <span class="product-badge">Art Paper</span>
        </div>
        <div class="product-info">
          <h3>Kartu Nama Art Paper 260gsm</h3>
          <p>Kertas art paper dengan permukaan halus, hasil cetak tajam. Pilihan ekonomis untuk kebutuhan sehari-hari.</p>
          <div class="product-price">Rp 50.000 / box</div>
          <a href="javascript:void(0)" class="btn-order" onclick="openOrderModal('Kartu Nama Art Paper', 50000)">Pesan via WA</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 col-sm-6 product-item" data-aos="fade-up" data-aos-delay="150">
      <div class="product-card">
        <div class="product-image">
          <img src="/assets/kartu-nama-art-carton.jpg" alt="Kartu Nama Art Carton" onclick="openLightbox(this.src)">
          <span class="product-badge">Art Carton</span>
        </div>
        <div class="product-info">
          <h3>Kartu Nama Art Carton 310gsm</h3>
          <p>Lebih tebal dan kokoh, cocok untuk kartu nama premium. Tersedia finishing doff atau glossy.</p>
          <div class="product-price">Rp 65.000 / box</div>
          <a href="javascript:void(0)" class="btn-order" onclick="openOrderModal('Kartu Nama Art Carton', 65000)">Pesan via WA</a>
        </div>
      </div>
    </div>

    <!-- Kartu Nama Doff / Matte -->
    <div class="col-md-4 col-sm-6 product-item" data-aos="fade-up" data-aos-delay="200">
      <div class="product-card">
        <div class="product-image">
          <img src="/assets/kartu-nama-doff.jpg" alt="Kartu Nama Doff" onclick="openLightbox(this.src)">
          <span class="product-badge">Doff / Matte</span>
        </div>
        <div class="product-info">
          <h3>Kartu Nama Doff / Matte</h3>
          <p>Finishing doff memberikan kesan elegan dan tidak reflektif. Tidak mudah kotor dan terlihat premium.</p>
          <div class="product-price">Rp 70.000 / box</div>
          <a href="javascript:void(0)" class="btn-order" onclick="openOrderModal('Kartu Nama Doff', 70000)">Pesan via WA</a>
        </div>
      </div>
    </div>

    <!-- Kartu Nama Glossy / Laminasi -->
    <div class="col-md-4 col-sm-6 product-item" data-aos="fade-up" data-aos-delay="250">
      <div class="product-card">
        <div class="product-image">
          <img src="/assets/kartu-nama-glossy.jpg" alt="Kartu Nama Glossy" onclick="openLightbox(this.src)">
          <span class="product-badge">Glossy</span>
        </div>
        <div class="product-info">
          <h3>Kartu Nama Glossy / Laminasi</h3>
          <p>Laminasi glossy membuat kartu lebih mengilap dan tahan air. Warna lebih hidup dan mencolok.</p>
          <div class="product-price">Rp 75.000 / box</div>
          <a href="javascript:void(0)" class="btn-order" onclick="openOrderModal('Kartu Nama Glossy', 75000)">Pesan via WA</a>
        </div>
      </div>
    </div>

    <!-- Kartu Nama Premium / Emboss -->
    <div class="col-md-4 col-sm-6 product-item" data-aos="fade-up" data-aos-delay="300">
      <div class="product-card">
        <div class="product-image">
          <img src="/assets/kartu-nama-premium.jpg" alt="Kartu Nama Premium" onclick="openLightbox(this.src)">
          <span class="product-badge">Premium</span>
        </div>
        <div class="product-info">
          <h3>Kartu Nama Premium / Emboss</h3>
          <p>Dengan efek timbul (emboss) dan pilihan bahan eksklusif. Memberikan kesan mewah dan profesional.</p>
          <div class="product-price">Rp 100.000 / box</div>
          <a href="javascript:void(0)" class="btn-order" onclick="openOrderModal('Kartu Nama Premium', 100000)">Pesan via WA</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 col-sm-6 product-item" data-aos="fade-up" data-aos-delay="350">
      <div class="product-card">
        <div class="product-image">
          <img src="/assets/kartu-nama-custom.jpg" alt="Kartu Nama Custom" onclick="openLightbox(this.src)">
          <span class="product-badge">Custom</span>
        </div>
        <div class="product-info">
          <h3>Kartu Nama Custom</h3>
          <p>Bentuk, ukuran, dan bahan sesuai keinginan. Konsultasikan dengan tim kami untuk hasil terbaik.</p>
          <div class="product-price">Mulai Rp 60.000</div>
          <a href="javascript:void(0)" class="btn-order" onclick="openOrderModal('Kartu Nama Custom', 60000)">Pesan via WA</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-body">
        <form id="orderForm">
          ...
          <div class="mb-3">
            ...
            <div class="fw-bold fs-4 text-primary" id="modalTotalPrice">Rp 50.000</div>
          </div>
          <div class="mb-3">
  ...
  <div class="row justify-content-center">
    <div class="col-md-8 text-center" data-aos="zoom-in" data-aos-duration="800">
      <div class="p-5" style="background: var(--primary-light); border-radius: 20px;">
        <h3 class="fw-bold mb-3">Butuh Desain Kartu Nama?</h3>
        <p class="mb-4">Tim desainer kami siap membantu membuat desain kartu nama yang profesional dan menarik. Gratis konsultasi!</p>
        <a href="https://wa.me/6283171125657?text=Halo%20saya%20butuh%20bantuan%20desain%20kartu%20nama" class="btn-order" style="width: auto; padding: 12px 30px;" target="_blank">Konsultasi Gratis</a>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="accordion-item" data-aos="fade-up">
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            <ol class="mb-0">
              <li>Pilih produk yang kamu mau di halaman ini (Kartu Nama, dll).</li>
...
<script>
  ...
  const productPrices = {
    'Kartu Nama Art Paper': 50000,
    'Kartu Nama Art Carton': 65000,
    'Kartu Nama Doff': 70000,
    'Kartu Nama Glossy': 75000,
    'Kartu Nama Premium': 100000,
    'Kartu Nama Custom': 60000
  };
  ...
  function updateModalPrice() {
    const price = parseInt(document.getElementById('productPrice').value) || 50000;
